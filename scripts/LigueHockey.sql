...
--
-- Hôte : localhost:3306
-- Généré le : mar. 10 juin 2025 à 13:01
...
--
-- Base de données : `LigueHockey`
--
CREATE DATABASE IF NOT EXISTS `LigueHockey` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `LigueHockey`;
...
('20221021121919_InitialMigration', '8.0.7'),
('20241207012625_AjoutStatsEquipe', '8.0.7'),
('20241217155108_AjoutStatsDonneesDiverses', '8.0.7'),
('20250417004330_AjoutCalendrier', '8.0.15'),
('20250606201013_ModifierNomTableCalendrier', '8.0.15');
